  ...
  return (
    <div className="retro-homepage bg-cream-100 min-h-screen font-mono text-gray-800 flex flex-col">
      ...
      <header className="retro-header p-4 flex justify-between items-center border-b-2 border-gray-800">
        ...
        <div style={{ width: '80px' }}></div> {/* Spacer to balance title */}
      </header>
      ...
      <main className="p-4 md:p-8 flex-grow">
        ...
        >
          {/* Gambar Layanan */}
          <img
            src="/image/powerpoint-banner.png"
            alt={serviceName}
          ...
          <p className="mb-4 text-sm leading-relaxed">
            Kami membuat presentasi PowerPoint yang profesional, menarik, dan informatif untuk kebutuhan bisnis, akademik, atau personal Anda. Desain slide yang bersih dan modern untuk menyampaikan pesan Anda dengan efektif.
          </p>
